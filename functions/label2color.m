...
%=================================================================================
%This function is used to draw resulting map
%input arguments:  label        :  labels of training and predictive pixels
%                  data_name    :  hyperspectral image data
%                  'uni'       --  Pavia University scene
%                  'center'    --  Pavia Centre scene
%                  'intia'     --  Indian Pines scene
%                  'dc'        --  Washington DC scene
%output arguments: classif       : the resulting map
%=================================================================================
[w h]=size(label);
...
switch lower(data_name)
    ...
    case 'india'
        map=[140 67 46;0 0 255;255 100 0;0 255 123;164 75 155;101 174 255;118 254 172; 60 91 112;255,255,0;255 125 125;255 0 255;100 0 255;0 172 254;0 255 0;171 175 80;101 193 60];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
